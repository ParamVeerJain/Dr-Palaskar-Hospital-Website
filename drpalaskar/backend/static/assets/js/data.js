/* ============================================================
   Dr. Palaskar Hospital — Site content data
   Single source of truth for the standalone static site.
   (The FastAPI backend exposes the same data at /api/*,
    and the Next.js frontend mirrors it in src/lib/data.ts)
   ============================================================ */
window.SITE = {
  clinic: {
  ...
  doctor: {
    ...
    bio: "Dr. Sameer Palaskar is a highly skilled orthopaedic surgeon with deep expertise in trauma care, joint replacement, arthroscopy and spine surgery. Across nearly three decades he has managed thousands of complex bone, joint and spine conditions, and is known for a patient-centred approach that pairs medical excellence with genuine compassion.",
    highlights: [
  ...
  // 14 treatments scraped from the original site, rewritten cleanly.
  treatments: [
